...
So far, we have [created a Voice User Interface](./setup-vui-alexa-hosted.md) and [a Code function](./create-alexa-hosted-function.md).  Your skill is now ready to test.
...
2.  **Other testing methods to consider:**
